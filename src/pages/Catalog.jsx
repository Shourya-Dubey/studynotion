...
export default function Catalog() {
  ...
  return (
    <>
      ...
      {/* Section 3 */}
      <div className=" mx-auto box-content w-11/12 max-w-maxContentTab px-10 py-12 lg:max-w-maxContent">
        <div className="section_heading">Frequently Bought</div>
        <div className="py-8">
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 w-[100%]">
